...
object RDDTransformations {
  def main(args: Array[String]) {
    ...
    val inputText = spark.sparkContext.textFile("datasets/test_file.txt")
    val inputLine = spark.sparkContext.parallelize(List("Hello Rahul", "Hi"))
    val input =spark.sparkContext.parallelize(List(1, 2, 3, 4, 5, 6, 7, 8))
    val inputData = spark.sparkContext.parallelize(1 to 9, 3)
    val inputData1 = spark.sparkContext.parallelize(1 to 9)
    ...
    val mapPartitionsWithIndexRseult = inputData.mapPartitionsWithIndex((index: Int, it: Iterator[Int]) => it.toList.map(x => index + ", " + x).iterator)
     ...
     */
    val inputRdd1 = spark.sparkContext.parallelize(List(1, 2, 3))
    val inputRdd2 =spark.sparkContext.parallelize(List(3, 5, 7))
     ...
     */
    val distinctInput = spark.sparkContext.parallelize(List(1, 2, 3, 4, 2, 1, 3, 4, 2, 5, 6))
     ...
     */
    val inputSubtract1 = spark.sparkContext.parallelize(List(1, 2, 3))
    val inputSubtract2 = spark.sparkContext.parallelize(List(3, 5, 6))
     ...
     */
    val inputCartesian1 = spark.sparkContext.parallelize(List(1, 2, 3))
    val inputCartesian2 = spark.sparkContext.parallelize(List(3, 5, 7))
     ...
     */
    val inputTupplesIs = spark.sparkContext.parallelize(List((1, 2), (3, 4), (4, 6)))
     ...
     */
    val inputTupplesList = spark.sparkContext.parallelize(List((1, 2), (3, 5), (3, 7)))
    ...
    val inputTupples = spark.sparkContext.parallelize(List((1, 2), (3, 5), (3, 7)))
    val inputTuppless = spark.sparkContext.parallelize(List((5, 9)))
     ...
     */
    val inputTupple1 = spark.sparkContext.parallelize(List((1, 2), (3, 4), (4, 7)))
    val inputTupple2 = spark.sparkContext.parallelize(List((5, 9)))
     ...
     */
    val inputElementTupple1 = spark.sparkContext.parallelize(List((1, 2), (3, 4), (4, 6)))
    val inpuElementtTupple2 = spark.sparkContext.parallelize(List((4, 9)))
